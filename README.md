...
![screenshot of past hour](assets/images/past-hour.PNG)

The current hour is displayed in red:


![screenshot of current hour](assets/images/current-hour.PNG)

Any future hour is displayed in green:

![screenshot of future hour](assets/images/future-hour.PNG)
